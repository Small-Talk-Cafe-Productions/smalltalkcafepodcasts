...
export const siteConfig: SiteConfig = {
  ...
  seo: {
    ...
    description: 'Learn Spanish, French, Italian, German or Swedish with Small Talk Café — bite-sized podcast episodes with real conversations. New episodes every day on Spotify & Apple Podcasts.',
    keywords: [
